...
var PrecompiledContractsBerlin = map[common.Address]PrecompiledContract{
	common.BytesToAddress([]byte{19}): &blsFastAggregateVerify{},
	common.BytesToAddress([]byte{1}):  &ecrecover{},
	common.BytesToAddress([]byte{2}):  &sha256hash{},
	common.BytesToAddress([]byte{3}):  &ripemd160hash{},
	common.BytesToAddress([]byte{4}):  &dataCopy{},
...
type blsFastAggregateVerify struct{}

// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *blsFastAggregateVerify) RequiredGas(input []byte) uint64 {
	return 200
}

func (c *blsFastAggregateVerify) Run(input []byte) ([]byte, error) {
	log.Warn("Using blsFastAggregateVerify precompile")
	out := make([]byte, 64)
	out[31] = 42
	out[63] = 42
	return out, nil
